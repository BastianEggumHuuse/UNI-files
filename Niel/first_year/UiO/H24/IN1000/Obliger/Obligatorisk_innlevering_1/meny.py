...
# 4) - her var jeg litt usikker med hvordan jeg skulle gjøre oppgaven. Den gjør akkurat det omvendte (med not) av det som er over.

if not(bruker_hoved == hovedretter[2] and bruker_side == sideretter[0]):
    print("\nDu spiser ikke nok grønnsaker!\n")
elif not((bruker_hoved == hovedretter[0] or bruker_hoved == hovedretter[1]) and bruker_side == sideretter[1]):
    print("\nDu har valgt et vegetarmåltid.\n")
else:
    print(f"\nDu har valgt {bruker_hoved} med {bruker_side}.\n")