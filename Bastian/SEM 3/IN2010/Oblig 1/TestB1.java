...
class TestB1
{
    public static void main(String[] args) {
        ...
        try {
            ...
            String Path1 = "B1Outputs/";
            String Path2 = "ExpectedOutputs/";

            for(File data : new File(Path1).listFiles())
            {
                // Reading
                Scanner reader1 = new Scanner(data);
                Scanner reader2 = new Scanner(new File(Path2 + data.getName()));

                System.out.println("Reading file " + data.getName() + "...");
